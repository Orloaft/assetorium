...
await page.evaluate(([g, c]) => { window.__g = g; window.__c = c; }, [
  ...
  b64("/mnt/nxt-dev/asset-forge/docs/cliff-from-face.png"),
]);
...
await page.screenshot({ path: `${SHOT}/41-fromface.png` });
...
await page.screenshot({ path: `${SHOT}/42-fromface-zoom.png` });
