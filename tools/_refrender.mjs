...
await page.evaluate(([g, c]) => { window.__g = g; window.__c = c; }, [
  ...
  b64("/mnt/nxt-dev/asset-forge/docs/cliff-edge-reference.png"),
]);
...
await page.screenshot({ path: `${SHOT}/37-ref-render.png` });
...
await page.screenshot({ path: `${SHOT}/38-ref-render-zoom.png` });
